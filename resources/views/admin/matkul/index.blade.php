    ...
    <div class="container">
        ...
        <div class="welcome-banner">
            ...
            <div class="welcome-character2">
                <img src="{{ asset('assets/img/subjects.png') }}" alt="subjects" class="img-fluid">
            </div>
        ...
        <a href="{{ route('matkul.create') }}" class="btn btn-add-subject"><i class="fas fa-plus me-1"></i> Add Subject</a>
