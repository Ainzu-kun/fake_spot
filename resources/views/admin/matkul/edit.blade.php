...
<body>
    ...
    <div class="form-container">
        <h2 class="text-center mb-4">Update Subject Data</h2>
        ...
        <form action="{{ route('matkul.update', ['matkul_id' => $matkul->id]) }}" method="POST">
            ...
            <div class="form-group mb-3">
                ...
                <div class="input-group">
                    ...
                    <input type="text" name="kode_mk" value="{{ $matkul->kode_mk }}" class="form-control" placeholder="Contoh: IF123" required>
                </div>
            </div>
            ...
            <div class="form-group mb-3">
                ...
                <div class="input-group">
                    ...
                    <input type="text" name="nama_mk" value="{{ $matkul->nama_mk }}" class="form-control" placeholder="Contoh: Pemrograman Web" required>
                </div>
            </div>
            ...
            <div class="form-group mb-3">
                ...
                <div class="input-group">
                    ...
                    <input type="number" name="sks" value="{{ $matkul->sks }}" class="form-control" placeholder="Contoh: 3" required>
                </div>
            </div>
            ...
            <!-- Tombol -->
            <button type="submit" class="btn btn-dark w-100">Edit Data Subject</button>
        </form>
    </div>
</body>
</html>
