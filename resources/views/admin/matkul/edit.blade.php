        ...
        <form action="{{ route('matkul.update', ['matkul_id' => $matkul->id]) }}" method="POST">
            ...
            <div class="form-group mb-3">
                ...
                <div class="input-group">
                    ...
                    <input type="text" name="kode_mk" value="{{ $matkul->kode_mk }}" class="form-control" required />
                </div>
            </div>
            ...
            <div class="form-group mb-3">
                ...
                <div class="input-group">
                    ...
                    <input type="text" name="nama_mk" value="{{ $matkul->nama_mk }}" class="form-control" required />
                </div>
            </div>
            ...
            <div class="form-group mb-3">
                ...
                <div class="input-group">
                    ...
                    <input type="number" name="sks" value="{{ $matkul->sks }}" class="form-control" required />
                </div>
            </div>
