    ...
    <div class="container">
        ...
        <div class="welcome-banner">
            ...
            <div class="welcome-character2">
                <img src="{{ asset('assets/img/semester.png') }}" alt="semester" class="img-fluid">
            </div>
        ...
        <a href="{{ route('semester.create') }}" class="btn btn-add-subject"><i class="fas fa-plus me-1"></i>Add Semester</a>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('semester.edit', ['semester_id' => $semester->id]) }}">
                                <img src="{{ asset('assets/icon/logo_edit.png') }}" alt="Tombol Edit" class= "action-icon me-1">
                            </a>
